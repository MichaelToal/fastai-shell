...
create () {
  ...
  setup_script="https://raw.githubusercontent.com/MichaelToal/fastai-shell/master/setup-gce.sh?__ts=$RANDOM"
...
help() {
  echo ""
  echo "fastai-shell"
  echo "visit: https://github.com/MichaelToal/fastai-shell"
  echo "----------------------------------------------"
  echo ""
